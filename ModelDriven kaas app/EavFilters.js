...
function filterFlavourlookup(executionContext) {


    var ApplicableForm = "cr981_flavour" //Input target lookup colum schema name
    var forToFilter = "cr981_atribute" // input eav column schema name
    var filterID = "569070001" // input choice column number id
...
function filterMachinelookup(executionContext) {


    var ApplicableForm = "cr981_equipment" //Input target lookup colum schema name
    var forToFilter = "cr981_atribute" // input eav column schema name
    var filterID = "569070000" // input choice column number id
